    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
      ...
      <div class="space-y-4">
        <div class="bg-muted rounded-lg overflow-hidden h-96 lg:h-[500px] flex items-center justify-center">
          <img :src="productData.images[selectedImage]" :alt="productData.name" class="w-full h-full object-cover" />
        </div>

        <div class="grid grid-cols-4 gap-3">
          <button v-for="(image, index) in productData.images" :key="index" @click="selectedImage = index" :class="[
      ...
      <div class="space-y-6">
        ...
        <div class="space-y-2">
          <div class="flex items-baseline gap-3">
            ...
            <span class="text-lg text-muted-foreground line-through">R$ {{ productData.originalPrice.toFixed(2)
              }}</span>
          </div>
        ...
        <div>
          ...
          <div class="flex gap-3">
            <button v-for="color in productData.colors" :key="color" @click="selectedColor = color" :class="[
        ...
        <div class="space-y-3">
          ...
          <div class="flex items-center gap-4">
            ...
            <span class="text-sm text-muted-foreground">{{ quantity > 5 ? 'Quantidade limitada em estoque' : ''
              }}</span>
          </div>
        </div>
        ...
        <div class="flex gap-3 pt-4">
          <button @click="addToCart()"
            class="flex-1 bg-blue-500 hover:bg-blue-600 text-white px-4 py-3 rounded-lg flex items-center justify-center gap-2">
    ...
    <section class="mb-12">
      <div class="p-6 bg-white rounded-lg border border-border">
        ...
        <div v-if="expandedSpecs" class="mt-6 space-y-4">
          <div v-for="([key, value], idx) in specsEntries" :key="key"
